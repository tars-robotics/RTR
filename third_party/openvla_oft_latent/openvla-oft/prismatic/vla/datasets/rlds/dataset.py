...
from prismatic.vla.datasets.rlds.utils.data_utils import (
    ...
    normalize_action_and_proprio_noop_for_vae,
    normalize_proprio_not_normalize_action,
    pprint_data_mixture,
    tree_map,
)
...
def make_dataset_from_rlds(
    ...
    *,
    ...
    if not use_rdp_vae:
        ...
        dataset = dataset.traj_map(
            partial(
                normalize_proprio_not_normalize_action,# not normalize action, instead, normalize action in vae
                # normalize_action_and_proprio,
                # normalize_action_and_proprio_noop_for_vae,
                metadata=dataset_statistics,
                normalization_type=action_proprio_normalization_type,
    ...
    print(f"dataset_statistics is {dataset_statistics}")
...
def make_interleaved_dataset(
    ...
    *,
    ...
    for dataset_kwargs in dataset_kwargs_list:
        ...
        _, dataset_statistics = make_dataset_from_rlds(**data_kwargs, train=train, vae=vae,use_rdp_vae=use_rdp_vae)
