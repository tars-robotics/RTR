...
class OpenvlaOftModelWrapper(AbsModelWrapper):
    def __init__(
        ...
        self.vae = vae
        payload = torch.load(vae_ckpt_path)
        ...
        self.vae._load_dataset_statistics(self.dataset_statistics_path)
    ...
    def predict_action_chunk(self, obs_dict: Dict[str, np.ndarray]) -> np.ndarray:
        ...
        action_chunk = self.vae.denormalize_from_dataset(action_chunk)
