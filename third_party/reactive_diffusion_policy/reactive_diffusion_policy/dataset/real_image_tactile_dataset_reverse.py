...
class RealImageTactileDatasetReverse(BaseImageDataset):
    def __init__(self,
                 shape_meta: dict,
                 dataset_path: str,
                 horizon=1,
                 ...
                 reverse_length=0 # default 0: do not predict past actions
                 ):
        ...
        key_first_k = dict()  # intentionally clear: take all observations
    ...
    def __getitem__(self, idx: int) -> Dict[str, torch.Tensor]:
        ...
        T_slice = slice(self.reverse_length, self.reverse_length+self.n_obs_steps, 1)
        ...
        for key in self.rgb_keys:
            ...
            # ${at.n_obs_steps}*${at.dataset_obs_temporal_downsample_ratio} 2*2 -> 4
        ...
        for key in self.lowdim_keys:
            if 'wrt' not in key:
                ...
                # print(data[key][:, :self.shape_meta['obs'][key]['shape'][0]][T_slice])
                # print(f"obs_dict[key].shape is {obs_dict[key].shape}")
                # print(obs_dict[key])
                # print(obs_downsample_ratio)
                # print("====================")
                # save ram
