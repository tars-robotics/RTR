...
class LatentDiffusionUnetImagePolicy(DiffusionUnetImagePolicy):
    ...
    def predict_action(self,
        ...
        if return_latent_action:
            ...
            # print(action_pred) # along the original_horizon dim all latents are identical; we rely heavily on the decoder to turn this identical chunk into per-timestep actions
        else:
