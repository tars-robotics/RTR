...
dataset_name="peel_cucumber15hz_oft6drotate_dataset"
run_root_dir="data/peel_cucumber_15hz_oft_6drotate_horizon48_not_latent"
run_id_override="peel_cucumber_15hz_not_latent_worldsize${world_size}"
