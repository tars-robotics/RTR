...
dataset_name="write_board15hz_oft6drotate_dataset"
run_root_dir="./data/write_board_15hz_oft_6drotate_horizon48_not_latent"
run_id_override="write_board_15hz_not_latent_worldsize${world_size}"
