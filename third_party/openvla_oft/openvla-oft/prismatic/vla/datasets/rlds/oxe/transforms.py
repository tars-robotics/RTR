...
def vase_sponge_test1_oft_6drotate_dataset_dataset_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    # gripper action is in -1 (open)...1 (close) --> clip to 0...1, flip --> +1 = open, 0 = close
    gripper_action = trajectory["action"][:, -1:]
    gripper_action = invert_gripper_actions(tf.clip_by_value(gripper_action, 0, 1))
...
def vase_sponge_test1_15hz_oft_6drotate_dataset_dataset_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    # gripper action is in -1 (open)...1 (close) --> clip to 0...1, flip --> +1 = open, 0 = close
    gripper_action = trajectory["action"][:, -1:]
    gripper_action = invert_gripper_actions(tf.clip_by_value(gripper_action, 0, 1))
...
OXE_STANDARDIZATION_TRANSFORMS = {
    ...
    "vase_sponge_test1_oft_dataset": vase_sponge_test1_oft_dataset_dataset_transform,
    "vase_sponge_test1_oft_6drotate_dataset": vase_sponge_test1_oft_6drotate_dataset_dataset_transform,
    "vase_sponge_test1_15hz_oft_6drotate_dataset": vase_sponge_test1_15hz_oft_6drotate_dataset_dataset_transform,
    "peel_cucumber60hz_oft6drotate_dataset": vase_sponge_test1_oft_6drotate_dataset_dataset_transform,
    "peel_cucumber15hz_oft6drotate_dataset": vase_sponge_test1_oft_6drotate_dataset_dataset_transform,
    "write_board60hz_oft6drotate_dataset": vase_sponge_test1_oft_6drotate_dataset_dataset_transform,
    "write_board15hz_oft6drotate_dataset": vase_sponge_test1_oft_6drotate_dataset_dataset_transform,
}
