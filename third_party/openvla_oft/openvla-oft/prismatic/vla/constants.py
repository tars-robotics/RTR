...
# NOTE: chunksize is hard-coded here.
Rotate6d_CONSTANTS = {
    "NUM_ACTIONS_CHUNK": 48,
    "ACTION_DIM": 10,
    "PROPRIO_DIM": 8,
    "ACTION_PROPRIO_NORMALIZATION_TYPE": NormalizationType.BOUNDS_Q99,
}

Rotate6d_15hz_CONSTANTS = {
...
def detect_robot_platform():
    ...
    if "6d" in cmd_args and "15hz" in cmd_args:
        return "Rotate6d15hz"
    elif "6d" in cmd_args:
        return "Rotate6d"
...
elif ROBOT_PLATFORM == "Rotate6d15hz":
    constants = Rotate6d_15hz_CONSTANTS
