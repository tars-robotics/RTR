...
dataset="<your_username>/xarm_write_board_state9_60hz"
...
world_size=1 
run_id=train_logl1_latent_rdp_vae_write_board60hz_world${world_size}_steps${steps} # pi05_training
output_dir="outputs/pi05_training_logl1_latent_rdp_vae_write_board60hz_steps${steps}_world${world_size}"

vae_load_path="../../../data/ckpts/write_board_60hz/ckpts_abs/rdp_vae/n_embed_10/horizon48/latest.ckpt"
latent_dataset_statistics="../../../data/ckpts/write_board_60hz/ckpts_abs/rdp_vae/n_embed_10/horizon48/dataset_stats.json"
...
TORCHDYNAMO_DISABLE=1 CUDA_VISIBLE_DEVICES=7 accelerate launch --num_processes=${world_size} scripts/codes/train_pi0.5/lerobot_train_latent_rdp_vae.py \
    ...
    --policy.repo_id="<your_username>/xarm_write_board_60hz_pi0.5" \
