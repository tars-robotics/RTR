...
world_size=1 
run_id=time_25_12_30_train_logl1_wipe_vase_60hz_world${world_size}_steps${steps} # pi05_training
output_dir="outputs/pi05_training_logl1_wipe_vase_60hz_steps${steps}_world${world_size}"


# rm -rf ${output_dir}

# CUDA_VISIBLE_DEVICES=0,1,2,3 python scripts/codes/train_pi0.5/lerobot_train.py \
TORCHDYNAMO_DISABLE=1 CUDA_VISIBLE_DEVICES=1 accelerate launch --num_processes=${world_size} scripts/codes/train_pi0.5/lerobot_train.py \
