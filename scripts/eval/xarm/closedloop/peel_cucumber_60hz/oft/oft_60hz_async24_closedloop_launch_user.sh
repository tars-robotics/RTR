...
ckpt_path="data/peel_cucumber_60hz_oft_6drotate_horizon48_not_latent/peel_cucumber_60hz_not_latent_worldsize2--50000_chkpt"
compress_obs=False
...
python -m rtr_async_sys.user.simple_user \
    ...
    model_wrapper.unnorm_key="peel_cucumber60hz_oft6drotate_dataset"