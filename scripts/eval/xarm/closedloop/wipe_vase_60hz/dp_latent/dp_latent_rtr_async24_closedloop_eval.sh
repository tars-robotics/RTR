...
ckpt_path="data/ckpts/wipe_vase_60hz/ckpts_abs/ldp/with_rdp_vae/latest.ckpt"
at_ckpt_path="data/ckpts/wipe_vase_60hz/ckpts_abs/rdp_vae/n_embed_10/horizon48/latest.ckpt"
pca_load_dir="data/ckpts/wipe_vase_60hz/rdp_pca"
...
log_traj_dir="xarm_outputs/dp/traj/wipe_vase/dp_latent_rtr_async${async_num}"
...
python src/rtr_async_sys/runner/simple_runner.py \
    ...
    user0.model_wrapper.block_reuse=${block_reuse} \
    user0.model_wrapper.reuse_action_num=${reuse_action_num} \
