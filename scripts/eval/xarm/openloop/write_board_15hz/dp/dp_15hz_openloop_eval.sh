ckpt_path="data/ckpts/write_board_15hz/ckpts_abs/dp/horizon12/latest.ckpt"
pca_load_dir="data/ckpts/write_board_15hz/rdp_pca"
dataset_path="data/ckpts/write_board_15hz/rdp_zarr"
...
## for dataset eval
save_plot_action_path="outputs/openloop_eval/write_board/dp/dp_15hz_stride1.pkl"
eval_length=100 # 100 for test, using dataset_length for eval

inference_step_threshold=12
control_hz=1000
