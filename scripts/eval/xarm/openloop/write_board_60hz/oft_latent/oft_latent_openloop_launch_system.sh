...
## for dataset eval
save_plot_action_path="outputs/openloop_eval/write_board/oft/oft_latent_stride${sample_stride}.pkl"
...
python src/rtr_async_sys/tools/visualize_open_loop_xyz.py --mode 1 --pkl_path ${save_plot_action_path}