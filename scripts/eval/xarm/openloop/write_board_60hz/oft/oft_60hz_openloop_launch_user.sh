...
ckpt_path="data/write_board_60hz_oft_6drotate_horizon48_not_latent/write_board_60hz_not_latent_worldsize2--50000_chkpt"
compress_obs=False
...
python -m rtr_async_sys.user.simple_user \
    ...
    model_wrapper.unnorm_key="write_board60hz_oft6drotate_dataset"