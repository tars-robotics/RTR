ckpt_path="data/ckpts/peel_cucumber_60hz/ckpts_abs/dp/horizon48/latest.ckpt"
...
## for dataset eval
save_plot_action_path="outputs/openloop_eval/peel_cucumber/dp/dp_60hz_stride1.pkl"
