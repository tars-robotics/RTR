...
# Max pooling aggregates features over all points
# Output: [B, 1024] global feature vector
# 2. PointNetObsEncoder
# Observation encoder wrapper:

# Interface compatible with policy networks
# Read point cloud configuration from shape_meta
# Supports temporal input [B, T, N, 3] -> [B, T, 1024]
# Provides feature_dim and returns 1024