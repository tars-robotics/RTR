...
from rtr_async_sys.models.Tactile_Generation_Policy.tactile_generation_policy.model.action.vae_stride_scaling import ActionVAE
...
class VaeActModelWrapper(AbsModelWrapper):
    def __init__(
            self, 
