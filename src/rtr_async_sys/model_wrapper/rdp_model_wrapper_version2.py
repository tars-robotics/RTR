"""
TODO:
The base model predicts and stores latent actions, requests observations needed by the refiner from the controller at a higher frequency, refines them, and sends refined actions to the controller at a fixed rate.\\
Supports both use_rnn and non-use_rnn VAE variants.
"""
