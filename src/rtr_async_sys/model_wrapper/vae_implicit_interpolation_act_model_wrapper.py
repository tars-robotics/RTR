...
from rtr_async_sys.models.Tactile_Generation_Policy.tactile_generation_policy.model.action.vae_implicit_interpolation import ActionVAE
...
class VaeImplicitActModelWrapper(AbsModelWrapper):
    def __init__(
            self, 
        ...
        self.policy = ActionVAE(
            ...
            T_up_ratio=model_cfg.T_up_ratio
        ).to(device)
