...
from rtr_async_sys.models.reactive_diffusion_policy.model.vae_unet.vae_unet import ActionVAE
...
class VaeUnetModelWrapper(AbsModelWrapper):
    def __init__(
            self, 
        ...
        assert isinstance(self.policy, ActionVAE), "model should be ActionVAE in DpModelWrapper"
        self.policy:ActionVAE = self.policy.to(device)
